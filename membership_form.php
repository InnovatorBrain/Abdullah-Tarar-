...
if (!empty($_POST)) {
  ...
  $number = (int)ecom_get_setting('formno')['value']+1;
  $date = $_POST['date'];
  $name = $_POST['name'];
...
<body style="font-family: Arial; font-size: 15px; background: #C9CCD3;background-image: linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);
 background-blend-mode: lighten;">
  <!--?php include 'top.php' ?-->
  <div class="div">
    <a href="index.php"> Home </a> &gt;&gt; <a href="regulation.php"> Rules &amp; Regulations </a> &gt;&gt; <a href=""> Membership Form </a>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-7" style="text-align: center;padding: 30px;background-color: #b7f7b7;color: #388c15;margin-right: 20%;margin-left: 20%;margin-top: 2%;border: 1px solid #00e200;border-radius: 11px;">
        <p>Assalam o allaikum, Chairman of Pakistan Agricultural Scientists Forum is pleased and thanks for your application for the membership of this distinguished organization. Soon you will receive our response on your application. Best regards</p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <form action="./membership_form.php" method="post" enctype="multipart/form-data">
        <center>
          <h1 style="color: #3d834a;"> PAS Forum Membership Form </h1>
        </center>
        <div class="row">
          <div >
            <div class="col-25">
            ...
            <div class="col-30">
              <input type="number" name="number" value="<?php echo (int)ecom_get_setting('formno')['value']+1; ?>" placeholder="Form No..." readonly="true">
            </div>
          </div>
    ...
    border-radius: 7px;"><img id="uploadPreview" style="width: 100px; height: 100px;"></div>
            <input type="file" name="memberimg" onchange="PreviewImage(this);">
          </div>
        ...
        <div class="row">
          <div class="col-50">
            <label for="country"> Membership Type:<span class="required">*</span>
            </label>
          </div>
          <div class="col-50">
